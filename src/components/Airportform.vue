      ...
      <div>
        <form>
          <div class="form-content">
            ...
            <div ref="firstPlace">
              <span>出发</span>
              <input type="text" placeholder="输入城市" @click="showfPlace" />
              <i class="iconfont icon-jianpan" @click="toggleFirstPlace"></i>
              <Place v-show="showFirstPlace"></Place>
            </div>
            <div ref="firstDate">
              <span>日期</span>
            ...
            <div ref="showSecondPlace">
              <span>到达</span>
              <input type="text" placeholder="输入城市" />
              <i class="iconfont icon-jianpan"></i>
              <Place v-show="showSecondPlace" @test="sayHi"></Place>
            </div>
  ...
  mounted() {
    ...
    document.addEventListener(
      ...
      e => {
        // let dom =
        //   this.$refs.firstDate ||
        //   this.$refs.secondDate ||
        //   this.$refs.firstPlace ||
        //   this.$refs.secondPlace;
